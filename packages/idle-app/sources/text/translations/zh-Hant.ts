...
export const zhHant: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        experiments: '實驗功能',
        experimentsDescription: '預覽仍在開發中的功能。這些功能可能會在未來更新中更改或移除。',
        experimentalFeatures: '啟用實驗',
        experimentalFeaturesEnabled: '預覽功能已啟用',
        experimentalFeaturesDisabled: '僅使用穩定功能',
        webFeatures: 'Web 功能',
        webFeaturesDescription: '僅在 Idle 的 Web 版本中可用的功能。',
        ...
        markdownCopyV2: '增強複製',
        markdownCopyV2Subtitle: '長按複製完整 markdown',
        hideInactiveSessions: '隱藏非活躍工作階段',
        hideInactiveSessionsSubtitle: '僅在清單中顯示活躍的工作階段',
        enhancedSessionWizard: '基於設定檔的設置',
        enhancedSessionWizardEnabled: '從已儲存的設定檔建立工作階段',
        enhancedSessionWizardDisabled: '使用標準工作階段設置',
        showThinking: '顯示AI思考',
        showThinkingEnabled: 'AI推理步驟在訊息中可見',
        ...
        attributionDisabled: '署名已關閉',
        attributionFooter: '幫助更多人發現 Idle。隨時可以關閉。',
    },

    attribution: {
        promptTitle: '幫助更多人發現 Idle',
        promptBody: 'Idle 免費使用，但營運需要成本。開啟署名後，您的提交將包含 Co-Authored-By: Idle 標籤，幫助其他開發者發現這個工具。您可以隨時在設定中更改。',
        keepOn: '保留署名',
        turnOff: '關閉',
    },
