...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Idle Coder é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
        ...
        supportUsSubtitle: 'Pague-nos um café',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Pré-visualize recursos ainda em desenvolvimento. Podem mudar ou ser removidos em atualizações futuras.',
        experimentalFeatures: 'Ativar experimentos',
        experimentalFeaturesEnabled: 'Recursos de pré-visualização estão ativos',
        experimentalFeaturesDisabled: 'Usando apenas recursos estáveis',
        webFeatures: 'Recursos web',
        webFeaturesDescription: 'Recursos disponíveis apenas na versão web do Idle.',
        ...
        markdownCopyV2: 'Cópia aprimorada',
        markdownCopyV2Subtitle: 'Mantenha pressionado para copiar markdown completo',
        hideInactiveSessions: 'Ocultar sessões inativas',
        hideInactiveSessionsSubtitle: 'Mostrar apenas sessões ativas na sua lista',
        enhancedSessionWizard: 'Configuração por perfil',
        enhancedSessionWizardEnabled: 'Criar sessões a partir de perfis salvos',
        enhancedSessionWizardDisabled: 'Usando configuração de sessão padrão',
        showThinking: 'Mostrar pensamento da IA',
        showThinkingEnabled: 'Passos de raciocínio da IA visíveis nas mensagens',
        showThinkingDisabled: 'Blocos de raciocínio da IA ocultos',

        // Attribution
        attribution: 'Atribuição',
        idleAttribution: 'Atribuição Idle',
        attributionEnabled: 'Commits incluem Co-Authored-By: Idle',
        attributionDisabled: 'Atribuição desativada',
        attributionFooter: 'Ajuda outros a descobrir o Idle. Pode desativar a qualquer momento.',
    },

    attribution: {
        promptTitle: 'Ajude outros a encontrar o Idle',
        promptBody: 'O Idle é gratuito, mas mantê-lo tem um custo. Quando a atribuição está ativada, seus commits incluem uma tag Co-Authored-By: Idle — ajudando outros desenvolvedores a descobrir a ferramenta. Você pode alterar isso nas Configurações.',
        keepOn: 'Manter atribuição',
        turnOff: 'Desativar',
    },
    ...
    newSession: {
        ...
        noMachinesFound: 'Nenhuma máquina encontrada. Inicie uma sessão Idle no seu computador primeiro.',
        ...
        loadingMachines: 'Carregando suas máquinas...',
    },
    ...
    sessionInfo: {
        ...
        renameSessionSubtitle: 'Alterar o título da sessão',
        renameSessionPrompt: 'Insira o novo nome da sessão',
    ...
    agentInput: {
        permissionMode: {
            ...
            bypassPermissions: 'Pular permissões (perigoso)',
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Auto seguro',
            yolo: 'Auto completo',
            badgeReadOnly: 'Read Only Mode',
            badgeSafeYolo: 'Auto seguro',
            badgeYolo: 'Auto completo',
        },
        codexModel: {
            title: 'CODEX MODEL',
    ...
    settingsVoice: {
        ...
        apiKeyDescription: 'Use sua própria chave API do ElevenLabs para recursos de voz. Sua chave é criptografada de ponta a ponta.',
        apiKeyLabel: 'Chave API do ElevenLabs',
        apiKeyPlaceholder: 'Insira sua chave API do ElevenLabs',
        apiKeySave: 'Salvar chave',
        apiKeyDelete: 'Remover chave',
        apiKeyRegistered: 'Sua chave está ativa',
        apiKeyNotRegistered: 'Nenhuma chave registrada — usando chave da plataforma',
        apiKeySaved: 'Chave API salva com sucesso',
        apiKeyDeleted: 'Chave API removida',
        apiKeyEmpty: 'Por favor, insira uma chave API',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Idle Coder. Isso permitirá que o terminal envie e receba mensagens com segurança.',
    ...
    message: {
        ...
        thinkingExpanded: 'Pensando (toque para recolher)',
        thinkingCollapsed: 'Pensando... (toque para expandir)',
    },
    ...
    home: {
        ...
        newGroupMessage: 'Introduza um nome para o grupo de sessões',
    },
} as const;
