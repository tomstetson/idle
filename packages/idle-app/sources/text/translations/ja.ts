...
export const ja: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        experiments: '実験的機能',
        experimentsDescription: '開発中の機能をプレビューします。今後のアップデートで変更または削除される場合があります。',
        experimentalFeatures: '実験を有効化',
        experimentalFeaturesEnabled: 'プレビュー機能が有効です',
        experimentalFeaturesDisabled: '安定版機能のみを使用',
        webFeatures: 'Web機能',
        webFeaturesDescription: 'IdleのWebバージョンでのみ利用可能な機能。',
        ...
        markdownCopyV2: '拡張コピー',
        markdownCopyV2Subtitle: '長押しで完全なmarkdownをコピー',
        hideInactiveSessions: '非アクティブセッションを非表示',
        hideInactiveSessionsSubtitle: 'アクティブなセッションのみをリストに表示',
        enhancedSessionWizard: 'プロファイルベースの設定',
        enhancedSessionWizardEnabled: '保存したプロファイルからセッションを作成',
        enhancedSessionWizardDisabled: '標準セッション設定を使用',
        showThinking: 'AI思考を表示',
        showThinkingEnabled: 'AIの推論ステップをメッセージに表示',
