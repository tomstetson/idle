...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Idle Coder is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Preview features still in development. These may change or be removed in future updates.',
        experimentalFeatures: 'Enable Experiments',
        experimentalFeaturesEnabled: 'Preview features are active',
        experimentalFeaturesDisabled: 'Using stable features only',
        webFeatures: 'Web Features',
        webFeaturesDescription: 'Features available only in the web version of Idle.',
        ...
        markdownCopyV2: 'Enhanced Copy',
        markdownCopyV2Subtitle: 'Long-press to copy full markdown',
        hideInactiveSessions: 'Hide Inactive Sessions',
        hideInactiveSessionsSubtitle: 'Only show active sessions in your list',
        enhancedSessionWizard: 'Profile-Based Setup',
        enhancedSessionWizardEnabled: 'Create sessions from saved profiles',
        enhancedSessionWizardDisabled: 'Using standard session setup',
        showThinking: 'Show AI Thinking',
        showThinkingEnabled: 'AI reasoning steps visible in messages',
    ...
    newSession: {
        ...
        noMachinesFound: 'No machines found. Start a Idle session on your computer first.',
    ...
    session: {
        ...
        deleteGroupMessage: 'Sessions in this group will be moved back to the main list.',
    },
    ...
    agentInput: {
        permissionMode: {
            ...
            badgeBypassAllPermissions: 'Skip Perms',
    ...
    settingsVoice: {
        ...
        apiKeyTitle: 'API Key',
        apiKeyDescription: 'Use your own ElevenLabs API key for voice features. Your key is encrypted end-to-end.',
        apiKeyLabel: 'ElevenLabs API Key',
        apiKeyPlaceholder: 'Enter your ElevenLabs API key',
        apiKeySave: 'Save Key',
        apiKeyDelete: 'Remove Key',
        apiKeyRegistered: 'Your key is active',
        apiKeyNotRegistered: 'No key registered — using platform key',
        apiKeySaved: 'API key saved successfully',
        apiKeyDeleted: 'API key removed',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Idle Coder account. This will allow the terminal to send and receive messages securely.',
