...
export const es: TranslationStructure = {
    ...
    status: {
        ...
        error: 'error',
        online: 'en línea',
        onlineWithActivity: ({ time }: { time: string }) => `en línea · ${time}`,
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'Idle Coder es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
        ...
        supportUsSubtitle: 'Invítanos a un café',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Vista previa de funciones aún en desarrollo. Pueden cambiar o eliminarse en futuras actualizaciones.',
        experimentalFeatures: 'Activar experimentos',
        experimentalFeaturesEnabled: 'Las funciones de vista previa están activas',
        experimentalFeaturesDisabled: 'Usando solo características estables',
        webFeatures: 'Características web',
        webFeaturesDescription: 'Características disponibles solo en la versión web de Idle.',
        ...
        markdownCopyV2: 'Copia mejorada',
        markdownCopyV2Subtitle: 'Mantén pulsado para copiar markdown completo',
        hideInactiveSessions: 'Ocultar sesiones inactivas',
        hideInactiveSessionsSubtitle: 'Mostrar solo sesiones activas en tu lista',
        enhancedSessionWizard: 'Configuración por perfil',
        enhancedSessionWizardEnabled: 'Crear sesiones desde perfiles guardados',
        enhancedSessionWizardDisabled: 'Usando configuración de sesión estándar',
        showThinking: 'Mostrar pensamiento de IA',
        showThinkingEnabled: 'Pasos de razonamiento de IA visibles en mensajes',
    ...
    newSession: {
        ...
        noMachinesFound: 'No se encontraron máquinas. Inicia una sesión de Idle en tu computadora primero.',
        ...
        loadingMachines: 'Cargando tus máquinas...',
    },
    ...
    session: {
        ...
        deleteGroupMessage: 'Las sesiones de este grupo se moverán a la lista principal.',
    },
    ...
    sessionInfo: {
        ...
        renameSessionSubtitle: 'Cambiar el título de la sesión',
        renameSessionPrompt: 'Introduce el nuevo nombre de la sesión',
    ...
    agentInput: {
        permissionMode: {
            ...
            bypassPermissions: 'Saltar permisos (peligroso)',
    ...
    settingsVoice: {
        ...
        apiKeyDescription: 'Usa tu propia clave API de ElevenLabs para funciones de voz. Tu clave está cifrada de extremo a extremo.',
        apiKeyLabel: 'Clave API de ElevenLabs',
        apiKeyPlaceholder: 'Introduce tu clave API de ElevenLabs',
        apiKeySave: 'Guardar clave',
        apiKeyDelete: 'Eliminar clave',
        apiKeyRegistered: 'Tu clave está activa',
        apiKeyNotRegistered: 'Sin clave registrada — usando clave de la plataforma',
        apiKeySaved: 'Clave API guardada correctamente',
        apiKeyDeleted: 'Clave API eliminada',
        apiKeyEmpty: 'Por favor, introduce una clave API',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de Idle Coder. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
    ...
    welcome: {
        ...
        webSessionNote: 'Para sesiones persistentes, usa la app de Idle para iOS.',
    },
