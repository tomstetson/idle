...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Idle Coder és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Vista prèvia de funcions encara en desenvolupament. Poden canviar o ser eliminades en futures actualitzacions.',
        experimentalFeatures: 'Activar experiments',
        experimentalFeaturesEnabled: 'Les funcions de vista prèvia estan actives',
        experimentalFeaturesDisabled: 'Utilitzant només funcions estables',
        webFeatures: 'Funcions web',
        webFeaturesDescription: 'Funcions disponibles només a la versió web d\'Idle.',
        ...
        markdownCopyV2: 'Còpia millorada',
        markdownCopyV2Subtitle: 'Mantén premut per copiar el markdown complet',
        hideInactiveSessions: 'Amaga les sessions inactives',
        hideInactiveSessionsSubtitle: 'Mostra només les sessions actives a la llista',
        enhancedSessionWizard: 'Configuració per perfil',
        enhancedSessionWizardEnabled: 'Crea sessions des de perfils desats',
        enhancedSessionWizardDisabled: 'Usant la configuració de sessió estàndard',
        showThinking: 'Mostrar pensament de la IA',
        showThinkingEnabled: 'Passos de raonament de la IA visibles als missatges',
    ...
    newSession: {
        ...
        noMachinesFound: 'No s\'han trobat màquines. Inicia una sessió de Idle al teu ordinador primer.',
        ...
        loadingMachines: 'Carregant les teves màquines...',
    },
    ...
    agentInput: {
        permissionMode: {
            ...
            bypassPermissions: 'Saltar permisos (perillós)',
        ...
        codexPermissionMode: {
            ...
            badgeSafeYolo: 'Auto segur',
            badgeYolo: 'Auto complet',
        },
        codexModel: {
            title: 'CODEX MODEL',
    ...
    settingsVoice: {
        ...
        apiKeyDescription: 'Utilitza la teva pròpia clau API d\'ElevenLabs per a les funcions de veu. La teva clau està xifrada d\'extrem a extrem.',
        apiKeyLabel: 'Clau API d\'ElevenLabs',
        apiKeyPlaceholder: 'Introdueix la teva clau API d\'ElevenLabs',
        apiKeySave: 'Desa la clau',
        apiKeyDelete: 'Elimina la clau',
        apiKeyRegistered: 'La teva clau està activa',
        apiKeyNotRegistered: 'Sense clau registrada — s\'utilitza la clau de la plataforma',
        apiKeySaved: 'Clau API desada correctament',
        apiKeyDeleted: 'Clau API eliminada',
        apiKeyEmpty: 'Si us plau, introdueix una clau API',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Idle Coder. Això permetrà al terminal enviar i rebre missatges de forma segura.',
    ...
    welcome: {
        ...
        webSessionNote: 'Per a sessions persistents, utilitza l\'app d\'Idle per a iOS.',
    },
    ...
    home: {
        ...
        newSession: 'Nova sessió',
        newGroup: 'Nou grup',
        newGroupTitle: 'Crear grup',
        newGroupMessage: 'Introdueix un nom per al grup de sessions',
    },
} as const;
