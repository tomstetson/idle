...
export const zhHans: TranslationStructure = {
    ...
    settingsFeatures: {
        ...
        experiments: '实验功能',
        experimentsDescription: '预览仍在开发中的功能。这些功能可能会在未来更新中更改或移除。',
        experimentalFeatures: '启用实验',
        experimentalFeaturesEnabled: '预览功能已激活',
        experimentalFeaturesDisabled: '仅使用稳定功能',
        webFeatures: 'Web 功能',
        webFeaturesDescription: '仅在 Idle 的 Web 版本中可用的功能。',
        enterToSend: '回车发送',
        ...
        markdownCopyV2: '增强复制',
        markdownCopyV2Subtitle: '长按复制完整 markdown',
        hideInactiveSessions: '隐藏非活跃会话',
        hideInactiveSessionsSubtitle: '仅在列表中显示活跃会话',
        enhancedSessionWizard: '基于配置文件的设置',
        enhancedSessionWizardEnabled: '从已保存的配置文件创建会话',
        enhancedSessionWizardDisabled: '使用标准会话设置',
        showThinking: '显示AI思考',
        showThinkingEnabled: 'AI推理步骤在消息中可见',
