...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Idle Coder to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Podgląd funkcji wciąż w fazie rozwoju. Mogą się zmienić lub zostać usunięte w przyszłych aktualizacjach.',
        experimentalFeatures: 'Włącz eksperymenty',
        experimentalFeaturesEnabled: 'Funkcje podglądowe są aktywne',
        experimentalFeaturesDisabled: 'Używane tylko stabilne funkcje',
        webFeatures: 'Funkcje webowe',
        webFeaturesDescription: 'Funkcje dostępne tylko w wersji webowej Idle.',
        ...
        markdownCopyV2: 'Ulepszone kopiowanie',
        markdownCopyV2Subtitle: 'Przytrzymaj, aby skopiować pełny markdown',
        hideInactiveSessions: 'Ukryj nieaktywne sesje',
        hideInactiveSessionsSubtitle: 'Pokazuj tylko aktywne sesje na liście',
        enhancedSessionWizard: 'Konfiguracja z profilu',
        enhancedSessionWizardEnabled: 'Tworzenie sesji z zapisanych profili',
        enhancedSessionWizardDisabled: 'Używanie standardowej konfiguracji sesji',
        showThinking: 'Pokaż myślenie AI',
        showThinkingEnabled: 'Kroki rozumowania AI widoczne w wiadomościach',
    ...
    newSession: {
        ...
        noMachinesFound: 'Nie znaleziono maszyn. Najpierw uruchom sesję Idle na swoim komputerze.',
        ...
        loadingMachines: 'Ładowanie maszyn...',
    },
    ...
    session: {
        ...
        deleteGroupMessage: 'Sesje z tej grupy zostaną przeniesione z powrotem na główną listę.',
    },
    ...
    agentInput: {
        permissionMode: {
            ...
            bypassPermissions: 'Pomiń uprawnienia (niebezpieczne)',
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Bezpieczny auto',
            yolo: 'Pełny auto',
            badgeReadOnly: 'Read Only Mode',
            badgeSafeYolo: 'Bezpieczny auto',
            badgeYolo: 'Pełny auto',
        },
        codexModel: {
            title: 'CODEX MODEL',
    ...
    settingsVoice: {
        ...
        apiKeyDescription: 'Użyj własnego klucza API ElevenLabs do funkcji głosowych. Twój klucz jest szyfrowany end-to-end.',
        apiKeyLabel: 'Klucz API ElevenLabs',
        apiKeyPlaceholder: 'Wprowadź swój klucz API ElevenLabs',
        apiKeySave: 'Zapisz klucz',
        apiKeyDelete: 'Usuń klucz',
        apiKeyRegistered: 'Twój klucz jest aktywny',
        apiKeyNotRegistered: 'Brak zarejestrowanego klucza — używany klucz platformy',
        apiKeySaved: 'Klucz API zapisany pomyślnie',
        apiKeyDeleted: 'Klucz API usunięty',
        apiKeyEmpty: 'Proszę wprowadzić klucz API',
    },
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Idle Coder. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
    ...
    welcome: {
        ...
        webSessionNote: 'Aby sesje były trwałe, użyj aplikacji Idle na iOS.',
    },
    ...
    message: {
        ...
        thinkingExpanded: 'Myślenie (dotknij, aby zwinąć)',
        thinkingCollapsed: 'Myślenie... (dotknij, aby rozwinąć)',
    },
    ...
    home: {
        ...
        newGroupMessage: 'Wprowadź nazwę grupy sesji',
    },
} as const;
