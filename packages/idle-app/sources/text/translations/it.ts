...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'Idle Coder è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Anteprima delle funzionalità ancora in sviluppo. Potrebbero cambiare o essere rimosse in aggiornamenti futuri.',
        experimentalFeatures: 'Attiva esperimenti',
        experimentalFeaturesEnabled: 'Le funzionalità in anteprima sono attive',
        experimentalFeaturesDisabled: 'Usando solo funzionalità stabili',
        webFeatures: 'Funzionalità web',
        webFeaturesDescription: 'Funzionalità disponibili solo nella versione web di Idle.',
        ...
        markdownCopyV2: 'Copia migliorata',
        markdownCopyV2Subtitle: 'Tieni premuto per copiare il markdown completo',
        hideInactiveSessions: 'Nascondi sessioni inattive',
        hideInactiveSessionsSubtitle: 'Mostra solo le sessioni attive nella tua lista',
        enhancedSessionWizard: 'Configurazione da profilo',
        enhancedSessionWizardEnabled: 'Crea sessioni dai profili salvati',
        enhancedSessionWizardDisabled: 'Usando configurazione sessione standard',
        showThinking: 'Mostra pensiero AI',
        showThinkingEnabled: 'Passaggi di ragionamento AI visibili nei messaggi',
        showThinkingDisabled: 'Blocchi di ragionamento AI nascosti',

        // Attribution
        attribution: 'Attribuzione',
        idleAttribution: 'Attribuzione Idle',
        attributionEnabled: 'I commit includono Co-Authored-By: Idle',
        attributionDisabled: 'Attribuzione disattivata',
        attributionFooter: 'Aiuta gli altri a scoprire Idle. Puoi disattivarla in qualsiasi momento.',
    },

    attribution: {
        promptTitle: 'Aiuta gli altri a trovare Idle',
        promptBody: 'Idle è gratuito, ma mantenerlo ha un costo. Quando l\'attribuzione è attiva, i tuoi commit includono un tag Co-Authored-By: Idle — aiutando altri sviluppatori a scoprire lo strumento. Puoi cambiarlo nelle Impostazioni.',
        keepOn: 'Mantieni attribuzione',
        turnOff: 'Disattiva',
    },
    ...
    newSession: {
        ...
        noMachinesFound: 'Nessuna macchina trovata. Avvia prima una sessione Idle sul tuo computer.',
        ...
        loadingMachines: 'Caricamento delle macchine...',
    },
    ...
    agentInput: {
        permissionMode: {
            ...
            plan: 'Modalità piano',
            bypassPermissions: 'Salta permessi (pericoloso)',
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Auto sicuro',
            yolo: 'Auto completo',
            badgeReadOnly: 'Modalità sola lettura',
            badgeSafeYolo: 'Auto sicuro',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account Idle Coder. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
    ...
    message: {
        ...
        thinkingExpanded: 'Pensiero (tocca per comprimere)',
        thinkingCollapsed: 'Pensiero... (tocca per espandere)',
    },
