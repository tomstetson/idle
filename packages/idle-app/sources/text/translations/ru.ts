...
export const ru: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'О программе',
        aboutFooter: 'Idle Coder — мобильное приложение для работы с Codex и Claude Code. Использует сквозное шифрование, все данные аккаунта хранятся только на вашем устройстве. Не связано с Anthropic.',
        whatsNew: 'Что нового',
        ...
        supportUsSubtitle: 'Угостите нас кофе',
    ...
    settingsFeatures: {
        ...
        experimentsDescription: 'Предварительный просмотр функций, находящихся в разработке. Они могут измениться или быть удалены в будущих обновлениях.',
        experimentalFeatures: 'Включить эксперименты',
        experimentalFeaturesEnabled: 'Предварительные функции активны',
        experimentalFeaturesDisabled: 'Используются только стабильные функции',
        webFeatures: 'Веб-функции',
        webFeaturesDescription: 'Функции, доступные только в веб-версии Idle.',
        ...
        markdownCopyV2: 'Улучшенное копирование',
        markdownCopyV2Subtitle: 'Долгое нажатие для копирования полного markdown',
        hideInactiveSessions: 'Скрыть неактивные сессии',
        hideInactiveSessionsSubtitle: 'Показывать только активные сессии в списке',
        enhancedSessionWizard: 'Настройка по профилю',
        enhancedSessionWizardEnabled: 'Создание сессий из сохранённых профилей',
        enhancedSessionWizardDisabled: 'Используется стандартная настройка сессий',
        showThinking: 'Показать мышление AI',
        showThinkingEnabled: 'Шаги рассуждений AI видны в сообщениях',
    ...
    newSession: {
        ...
        noMachinesFound: 'Машины не найдены. Сначала запустите сессию Idle на вашем компьютере.',
        ...
        loadingMachines: 'Загрузка ваших машин...',
    },
    ...
    agentInput: {
        permissionMode: {
            ...
            bypassPermissions: 'Пропустить разрешения (опасно)',
        ...
        codexPermissionMode: {
            ...
            safeYolo: 'Безопасный авто',
            yolo: 'Полный авто',
            badgeReadOnly: 'Только чтение',
            badgeSafeYolo: 'Безопасный авто',
            badgeYolo: 'Полный авто',
        },
        codexModel: {
            title: 'CODEX MODEL',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Терминал запрашивает подключение к вашему аккаунту Idle Coder. Это позволит терминалу безопасно отправлять и получать сообщения.',
